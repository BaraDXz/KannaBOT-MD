      ...
      const count = args[1] && args[1].length > 0 ? Math.min(99999999, Math.max(parseInt(args[1]), 1)) : !args[1] || args.length < 3 ? 1 : Math.min(1, count)
        switch (type) {
          ...
          if (user.cat > 0) return m.reply('ʏᴏᴜ ᴀʟʀᴇᴀᴅʏ ʜᴀᴠᴇ ɪᴛ!')
            ...
            conn.sendButton(m.chat, `*${htki} NEW PET !${htka}*`, `🎉 ᴄᴏɴɢʀᴀᴛᴜʟᴀᴛɪᴏɴs, ʏᴏᴜ ʜᴀᴠᴇ ᴘᴜʀᴄʜᴀsᴇᴅ ᴘᴇᴛ *ᴄᴀᴛ*`, null, [['ɪɴᴠᴇɴᴛᴏʀʏ', '.inv'],['ғᴇᴇᴅ', '.feed kucing']],m)
            break
          case 'dog':
          if (user.dog > 0) return m.reply('ʏᴏᴜ ᴀʟʀᴇᴀᴅʏ ʜᴀᴠᴇ ɪᴛ!')
            ...
            conn.sendButton(m.chat, `*${htki} NEW PET !${htka}*`, `🎉 ᴄᴏɴɢʀᴀᴛᴜʟᴀᴛɪᴏɴs, ʏᴏᴜ ʜᴀᴠᴇ ᴘᴜʀᴄʜᴀsᴇᴅ ᴘᴇᴛ *ᴅᴏɢ*`, null, [['ɪɴᴠᴇɴᴛᴏʀʏ', '.inv'],['ғᴇᴇᴅ', '.feed anjing']],m)
            break
          case 'fox':
          if (user.fox > 0) return m.reply('ʏᴏᴜ ᴀʟʀᴇᴀᴅʏ ʜᴀᴠᴇ ɪᴛ!')
            ...
            conn.sendButton(m.chat, `*${htki} NEW PET !${htka}*`, `🎉 ᴄᴏɴɢʀᴀᴛᴜʟᴀᴛɪᴏɴs, ʏᴏᴜ ʜᴀᴠᴇ ᴘᴜʀᴄʜᴀsᴇᴅ ᴘᴇᴛ *ғᴏx*`, null, [['ɪɴᴠᴇɴᴛᴏʀʏ', '.inv'],['ғᴇᴇᴅ', '.feed rubah']],m)
            break
          case 'horse':
          if (user.horse > 0) return m.reply('ʏᴏᴜ ᴀʟʀᴇᴀᴅʏ ʜᴀᴠᴇ ɪᴛ!')
            ...
            conn.sendButton(m.chat, `*${htki} NEW PET !${htka}*`, `🎉 ᴄᴏɴɢʀᴀᴛᴜʟᴀᴛɪᴏɴs, ʏᴏᴜ ʜᴀᴠᴇ ᴘᴜʀᴄʜᴀsᴇᴅ ᴘᴇᴛ *ʜᴏʀsᴇ*`, null, [['ɪɴᴠᴇɴᴛᴏʀʏ', '.inv'],['ғᴇᴇᴅ', '.feed kuda']],m)
            break
          case 'petfood':
